...
\begin{document}
	...
	\noindent $V_{IH}$ and $V_{IL}$ are the unity points of the gain function. We specifically use the SPICE circuit shown in Figure \ref{fig::nand_noise_analysis} to measure the unity gain points in our netlist. These points, in turn, allow us to solve for the noise margins.	
