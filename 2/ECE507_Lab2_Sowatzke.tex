...
\begin{document}
	...
	\begin{tabular}{| c | c | c || c | c | c |}
		...
		\hline	
		$0 \rightarrow 1$ & $1$ & $28.574\ \text{ps}$ & $1 \rightarrow 0$ & $1$ & $44.343\ \text{ps}$\\
		\hline	
		$1$ & $0 \rightarrow 1$ & $18.748\ \text{ps}$ & $1$ & $1 \rightarrow 0$ & $29.313\ \text{ps}$\\
		\hline	
		$0 \rightarrow 1$ & $0 \rightarrow 1$ & $28.584\ \text{ps}$ & $1 \rightarrow 0$ & $1 \rightarrow 0$ & $21.234\ \text{ps}$\\
		\hline
	\end{tabular}
	\end{center}
	\end{table}
