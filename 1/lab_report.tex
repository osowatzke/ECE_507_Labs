...
\begin{document}
	...
	To improve the quality of our theoretical noise margin estimates, we can instead use parameters from in ngspice. We specifically use $V_M = 0.9108 V$ and $g = -14.83$, where $g$ is computed in Figure \ref{fig::nand_noise_analysis_g_sweep_va_vb}.
